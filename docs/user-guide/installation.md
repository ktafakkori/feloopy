...
=== ":material-console: User-specific"
    ...
    ``` console
    pip install -U "feloopy[stock]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[pico]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[pico]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[nano]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[nano]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[micro]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[micro]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[mini]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[mini]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[full]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[full]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[plus_gurobi]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[plus_gurobi]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[plus_cplex]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[plus_cplex]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[plus_xpress]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[plus_xpress]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[plus_copt]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[plus_copt]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[plus_gams]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[plus_gams]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[plus_insideopt]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[plus_insideopt]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[only_cylp]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[only_cylp]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[only_linux]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[only_linux]==0.3.0" --user
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[hyper]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[hyper]==0.3.0" --user
    ```
...
=== ":material-console: ipykernel"
    ...
    ``` console
    !pip install -U "feloopy[onlhypery_linux]==0.3.0"
    ```
...
=== ":material-console: System-wide"
    ...
    ``` console
    pip install -U "feloopy[mega]==0.3.0"
    ```

=== ":material-console: User-specific"

    ``` console
    pip install -U "feloopy[mega]==0.3.0" --user
    ```
